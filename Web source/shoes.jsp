...
<html lang="en">
  ...
  <body>
    ...
    <section class="main-section sub-section set-margin">
      ...
      <ul class="category-item-list shoes">
        <li class="category-item shoes">
          <a class="link" href="">
            <img class="item-img" src="./image/shoes/shoes1.jpg" alt="" />
          </a>
          <div class="item-info shoes">
            <span class="name">일반 운동화 - blue</span>

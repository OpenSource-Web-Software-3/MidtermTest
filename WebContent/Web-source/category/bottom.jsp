...
<html lang="en">
  ...
  <body>
    ...
    <section class="main-section sub-section set-margin">
      <div class="category-name">BOTTOM</div>
      <ul class="category-item-list bottom">
        <li class="category-item bottom">
          <a class="link" href="">
            <img class="item-img" src="./image/bottom/bottom1.jpg" alt="" />
          </a>
          <div class="item-info bottom">
            <span class="name">에코백 - white</span>
